...
Original file is located at
    https://colab.research.google.com/drive/1QZgXXV3J-e9MMBNsCC2qbr35xF1DQiR7
...
checkpoint = tf.keras.callbacks.ModelCheckpoint(root_dir + "pairwise_best_model.h5", monitor='val_auc', verbose=1, save_weights_only=True, save_best_only=True, mode='max', save_freq='epoch')
...
def createAndRun():
  ...
  model.save_weights('pairwise_final_model.h5')
